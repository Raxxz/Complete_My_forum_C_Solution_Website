...
<nav>
    <div id="logo_navbar">
        <a class = "mylogo myanker" style="background-color: purple;" href="/FORUM/home.php">𝕮-sOLUTION</a>
    </div>
    <div id="navbar">
        <a class = "mylogo1 myanker" style="background-color: purple;" href="/FORUM/home.php">𝕮-sOLUTION</a>
        <a class ="respnse myanker" href="/FORUM/home.php">Home</a>
    ...
    <div id="left">
        ...
        if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
            ...
            <a class="myclass" id ="logout" onclick="return question()" href="partials/_logout.php">Logout</a>
            ';
        }
